...
public class Utils {
	...
	public static final String HELP_MESSAGE = String.format(
		":information_source: **__Opaloby__**:\nBleep bloop! I am a bot. Pentox#6935 created "
				...
				+ "maker role name]`: Sets up this server with the specified arguments. You "
	...
	public static final String TOS = ":information_source: **__Opaloby Terms of Service__**:\nBy"
			...
			+ "overusing its commands repetitively and unnecessarily.\n**5.** THIS BOT COMES "
	...
	public static final String ADDBOT = 
			...
			+ "you don't have one. You can name it whatever you want.\nSecond, you will need "
			+ "to create an **open lobby channel**, if you haven't already. That's the channel where"
